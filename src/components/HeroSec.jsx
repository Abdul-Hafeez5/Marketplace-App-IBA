...
export const InputFields = ({ placeholder, svgIcon }) => {
  return (
    <div className="flex items-center rounded-[20px] bg-white px-5 py-4 gap-3 ">
      {/* <LuUser2 className="text-black" /> */}
      {svgIcon}
...
const HeroSec = () => {
  return (
    <div className="flex flex-col md:flex-row gap-[60px] text-white">
